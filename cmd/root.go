...
import (
	...
	"github.com/LeoFVO/gossti/cmd/detect"
	"github.com/LeoFVO/gossti/cmd/plugins"
...
func init() {
	...
	RootCmd.AddCommand(detect.RootCmd)
	RootCmd.AddCommand(plugins.RootCmd)
